  ...
  const services = [
    {
      ...
      description: "Protección avanzada para sus sistemas y datos con soluciones personalizadas de ciberseguridad.",
            ...
            <div className="lg:w-1/2">
              ...
              >
                <div className="glass-effect rounded-2xl p-6 shadow-xl">
                  <img  alt="Equipo de tecnología trabajando en soluciones digitales" className="rounded-xl w-full h-auto" src="https://images.unsplash.com/photo-1614064548237-096f735f344f" />
                </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-purple-600 rounded-lg"></div>
                <div className="relative z-10 glass-effect rounded-xl overflow-hidden">
                  <img  alt="Equipo de profesionales tecnológicos" className="w-full h-auto" src="https://images.unsplash.com/photo-1565598469107-2bd14ae7e7e4" />
                </div>
              </div>
            </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400">info@tuempresa.com</p>
                    </div>
                  </div>
